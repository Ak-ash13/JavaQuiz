...
class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==0)
		{
			l.setText("Que1: Which of this keyword can be used in a subclass to call the constructor of superclass?");
			jb[0].setText("super");jb[1].setText("this");jb[2].setText("extent");jb[3].setText("extends");
